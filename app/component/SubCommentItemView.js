...
export default class SubCommentItemView extends Component {
            ...
            <TouchableOpacity onPress={() => {
                ...
                <View style={styles.subCommentContainer}>
                    ...
                    <View style={styles.commentContainer3}>
                        ...
                        <Text style={styles.commentText1}>{this.state.data.user.nick_name} @ {this.state.data.to_user.nick_name}：{this.state.data.content}</Text>
